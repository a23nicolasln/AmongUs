...
class MenuItem extends ComponenteMenu {
    ...
    void ejecutar() {
        ...
        switch (nombre) {
            ...
            case "Modificar numero de impostores":
            ...
            case "Modificar numero de tareas":
...
public class MenuConfiguracion {
    ...
    public MenuConfiguracion() {
        ...
        MenuItem AgregarTarea = new MenuItem("Agregar Tarea", sc);
        MenuItem EliminarTarea = new MenuItem("Eliminar Tarea", sc);
        MenuItem VerTareas = new MenuItem("Ver Tareas", sc);
        ...
        MenuItem AgregarJugador = new MenuItem("Agregar Jugador", sc);
        MenuItem EliminarJugador = new MenuItem("Eliminar Jugador", sc);
        MenuItem VerJugadores = new MenuItem("Ver Jugadores", sc);
        MenuItem modificarImpostores = new MenuItem("Modificar numero de impostores", sc);
        MenuItem modificarTareas = new MenuItem("Modificar numero de tareas", sc);
        ...
        MenuItem Jugar = new MenuItem("Jugar", sc);
